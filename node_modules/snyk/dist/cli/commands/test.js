...
function displayResult(res, options) {
    ...
    if (res.ok && res.vulnerabilities.length === 0) {
        ...
        // to consider
        const snykPackageTestTip = !(localPackageTest || options.dev) ?
    ...
    if (localPackageTest && common_1.WIZARD_SUPPORTED_PMS.includes(packageManager)) {
...
function createRemediationText(vuln, packageManager) {
    let wizardHintText = '';
    if (common_1.WIZARD_SUPPORTED_PMS.includes(packageManager)) {
